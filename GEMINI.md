...
For UI work, evaluate desktop manager, tablet host-stand, and mobile server views. Use the tokens and interaction rules in `docs/DESIGN_SYSTEM.md`. If a Figma file is available, map components and variables to existing code before generating new components.

For code review, return prioritized findings with evidence and suggested tests. Do not duplicate formatting-only feedback already enforced by tooling.
