...
6. [ ] Connect the interactive reference UI to hosted Supabase mutations and Realtime subscriptions (Feature 015, Phases B–E — schedule and tips wired, CSV import wired as a side effect of schedule; allocation, registration, and team designations still pending)
