...
**Health Gate:** `npm run check` (Passing) | `npm test` (30/30 files, 187/187 tests passing) | `npm run test:e2e` (settings.spec.ts: 9/9 across desktop/host-tablet/server-mobile)  
...
- **Active Feature:** `Feature 023 — Settings Consolidation`
- **Active Task Spec:** [docs/features/023-settings-consolidation.md](file:///c:/Users/krapa/Documents/Projects/Restaurent/The%20Lineup/docs/features/023-settings-consolidation.md)
...
- **Current State:** Implemented on `feature/023-settings-consolidation` (branched off `feature/022-app-shell-brand-and-nav-hierarchy`); all quality gates green, acceptance criteria checked off. Pending PR/merge.
