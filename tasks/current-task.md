...
- [x] **Step 1: Brand Updates (Login & App Shell)**
...
- [x] **Step 2: Desktop Two-Row Navigation (`restaurant-operations-app.tsx`)**
...
- [x] **Step 3: Mobile Bottom Navigation & More Sheet**
...
- [x] **Step 4: Cleanup & Quality Checks**
  - Verify UI components meet $\ge 44\text{px}$ touch target standards.
  - Fix E2E tests for Feature 021/022 UI Changes.
  - Fix outside-click and ref-stealing bugs with the duplicate Avatar menu.
